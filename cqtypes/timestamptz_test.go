...
func TestTimestamptzSet(t *testing.T) {
	...
	successfulTests := []struct {
		...
		{source: "2105-07-23 22:23:37.133334968 +0300 IDT m=+2610529275.484148261", result: Timestamptz{Time: time.Date(2105, 7, 23, 22, 23, 37, 133334968, time.Local), Status: Present}},
