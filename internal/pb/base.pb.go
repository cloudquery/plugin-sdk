...
var file_internal_pb_base_proto_rawDesc = []byte{
	...
	0x31, 0x22, 0x34, 0x0a, 0x07, 0x47, 0x65, 0x74, 0x4e, 0x61, 0x6d, 0x65, 0x1a, 0x09, 0x0a, 0x07,
...
var file_internal_pb_base_proto_goTypes = []interface{}{
	(*GetName)(nil),                     // 0: cloudquery.pluginsdk.v1.GetName
	(*GetVersion)(nil),                  // 1: cloudquery.pluginsdk.v1.GetVersion
	(*GetProtocolVersion)(nil),          // 2: cloudquery.pluginsdk.v1.GetProtocolVersion
	(*Configure)(nil),                   // 3: cloudquery.pluginsdk.v1.Configure
	(*GetName_Request)(nil),             // 4: cloudquery.pluginsdk.v1.GetName.Request
	(*GetName_Response)(nil),            // 5: cloudquery.pluginsdk.v1.GetName.Response
	(*GetVersion_Request)(nil),          // 6: cloudquery.pluginsdk.v1.GetVersion.Request
	(*GetVersion_Response)(nil),         // 7: cloudquery.pluginsdk.v1.GetVersion.Response
	(*GetProtocolVersion_Request)(nil),  // 8: cloudquery.pluginsdk.v1.GetProtocolVersion.Request
	(*GetProtocolVersion_Response)(nil), // 9: cloudquery.pluginsdk.v1.GetProtocolVersion.Response
	(*Configure_Request)(nil),           // 10: cloudquery.pluginsdk.v1.Configure.Request
	(*Configure_Response)(nil),          // 11: cloudquery.pluginsdk.v1.Configure.Response
}
