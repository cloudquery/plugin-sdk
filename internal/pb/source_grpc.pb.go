...
type SourceClient interface {
	...
	Validate(ctx context.Context, in *ValidateSource_Request, opts ...grpc.CallOption) (*ValidateSource_Response, error)
...
func (c *sourceClient) Validate(ctx context.Context, in *ValidateSource_Request, opts ...grpc.CallOption) (*ValidateSource_Response, error) {
	out := new(ValidateSource_Response)
	err := c.cc.Invoke(ctx, "/proto.Source/Validate", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type SourceServer interface {
	...
	// Validate returns warnings and errors about the spec.
	Validate(context.Context, *ValidateSource_Request) (*ValidateSource_Response, error)
	// GetSyncSummary returns the latest sync summary of the source plugin. we don't want to send the summary on
	// every sync request.
...
func (UnimplementedSourceServer) Validate(context.Context, *ValidateSource_Request) (*ValidateSource_Response, error) {
...
func _Source_Validate_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/proto.Source/Validate",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SourceServer).Validate(ctx, req.(*ValidateSource_Request))
	}
	return interceptor(ctx, in, info, handler)
}
