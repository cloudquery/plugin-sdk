...
type DestinationClient interface {
	...
	// Validate returns warnings and errors about the spec.
	Validate(ctx context.Context, in *ValidateDestination_Request, opts ...grpc.CallOption) (*ValidateDestination_Response, error)
...
func (c *destinationClient) Validate(ctx context.Context, in *ValidateDestination_Request, opts ...grpc.CallOption) (*ValidateDestination_Response, error) {
	out := new(ValidateDestination_Response)
	err := c.cc.Invoke(ctx, "/proto.Destination/Validate", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type DestinationServer interface {
	...
	// Validate returns warnings and errors about the spec.
	Validate(context.Context, *ValidateDestination_Request) (*ValidateDestination_Response, error)
	// Migrate tables to the given plugin version
...
func (UnimplementedDestinationServer) Validate(context.Context, *ValidateDestination_Request) (*ValidateDestination_Response, error) {
...
func _Destination_Validate_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ValidateDestination_Request)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/proto.Destination/Validate",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(DestinationServer).Validate(ctx, req.(*ValidateDestination_Request))
	}
	return interceptor(ctx, in, info, handler)
}
