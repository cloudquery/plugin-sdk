...
func (c *testDestinationClient) overwrite(table *schema.Table, data []interface{}) {
...
func (c *testDestinationClient) Migrate(_ context.Context, tables schema.Tables) error {
...
func (c *testDestinationClient) Read(_ context.Context, table *schema.Table, source string, res chan<- []interface{}) error {
	if c.memoryDB[table.Name] == nil {
		return nil
	}
