	...
	t.Run("add_column_not_null", func(t *testing.T) {
		...
		target := &schema.Table{
			Columns: schema.ColumnList{
				...
				schema.CqIDColumn,
				{Name: "id", Type: types.ExtensionTypes.UUID},
				{Name: "bool", Type: arrow.FixedWidthTypes.Boolean, CreationOptions: schema.CreationOptions{NotNull: true}},
			}}
		p := newPlugin()
	...
	t.Run("remove_column", func(t *testing.T) {
		...
		source := &schema.Table{
			...
			Columns: schema.ColumnList{
				...
				schema.CqSyncTimeColumn,
				schema.CqIDColumn,
				{Name: "id", Type: types.ExtensionTypes.UUID, CreationOptions: schema.CreationOptions{NotNull: true}},
				{Name: "bool", Type: arrow.FixedWidthTypes.Boolean, CreationOptions: schema.CreationOptions{NotNull: true}},
			}}
		target := &schema.Table{
			Columns: schema.ColumnList{
	...
	t.Run("change_column", func(t *testing.T) {
		...
		target := &schema.Table{
			...
			Columns: schema.ColumnList{
				...
				schema.CqIDColumn,
				{Name: "id", Type: types.ExtensionTypes.UUID},
				{Name: "bool", Type: arrow.BinaryTypes.String, CreationOptions: schema.CreationOptions{NotNull: true}},
			}}
