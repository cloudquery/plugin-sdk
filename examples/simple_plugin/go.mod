...
require (
	...
	github.com/aws/aws-sdk-go-v2/service/licensemanager v1.41.3 // indirect
	github.com/aws/aws-sdk-go-v2/service/marketplacemetering v1.39.3 // indirect
	...
	github.com/cloudquery/plugin-pb-go v1.27.16 // indirect
